...
import WalkBabaLogo  from "./assets/walkbaba-first2.png"
    ...
    return <>
        <div className="landingPage">
            <div className="landingPage-Content">
                <img src={WalkBabaLogo} width="300" height="100" box-shadow="0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)"/>

...
return (
    ...
    <main>
        ...
        {/*</div>*/}
        <a href={singleMapRouteData.exportLinks.exportMapLink} className="btn btn-primary btn-lg active" role="button"
           aria-pressed="true">Export Route</a>
        <a href={singleMapRouteData.exportLinks.exportStartMapLink} className="btn btn-primary btn-lg active"
           role="button" aria-pressed="true">Route with nav to start</a>
        <a href={singleMapRouteData.exportLinks.exportEndMapLink} className="btn btn-primary btn-lg active"
